...
void getpos(float u, float v, int i, float* pos) {  // p -> [0,2,3,4,4,3,2,1] -> 16      vertices -> vertice0(x,y,z), vertice1(x,y,z)), vertice2
...
void bezier(const char* forigin, float tess, char* file) {
    ...
    //for (int i = 0; i < n; i++) p[i] = (int*)malloc(16 * sizeof(int));
